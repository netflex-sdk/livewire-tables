...
trait HtmlComponents
{
     ...
     *
     * @param  MediaUrlResolvable|string $path
     * @param  string|null  $alt
     * @param  array  $attributes
     * @param string|int|array  $presetOrSize
     *
     * @return HtmlString
     */
    public function image($url, $presetOrSize = null, $alt = null, $attributes = []): HtmlString
    {
        $attributes['alt'] = $alt;

        return $this->html('<img src="' . media_url($url, $presetOrSize) . '"' . $this->attributes($attributes) . '>');
    }
